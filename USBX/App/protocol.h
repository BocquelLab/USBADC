...
enum {
  ...
  USBADC_PROTOCOL_REQUEST_PING,
  USBADC_PROTOCOL_REQUEST_READ_ADC,
  USBADC_PROTOCOL_REQUEST_WRITE_PIN,
  USBADC_PROTOCOL_REQUEST_REBOOT,

  // Client response to server
  USBADC_PROTOCOL_RESPONSE_PONG,
  USBADC_PROTOCOL_RESPONSE_READ_ADC,
  USBADC_PROTOCOL_RESPONSE_WRITE_PIN,
  USBADC_PROTOCOL_RESPONSE_ERROR,
};
