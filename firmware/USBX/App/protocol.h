...
enum USBADC_PROTOCOL_RESPONSE_ERROR_REASONS {
  USBADC_PROTOCOL_RESPONSE_ERROR_REASON_NOT_AVAILABLE = 0,
  USBADC_PROTOCOL_RESPONSE_ERROR_REASON_INVALID_DATA = 1,
  USBADC_PROTOCOL_RESPONSE_ERROR_REASON_TIMEOUT = 2,
